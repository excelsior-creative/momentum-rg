...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "search_rels" (
  	...
  	"articles_id" integer,
  	"projects_id" integer,
  	"industry_landing_pages_id" integer
  );
  ...
  ALTER TABLE "search_rels" ADD CONSTRAINT "search_rels_industry_landing_pages_fk" FOREIGN KEY ("industry_landing_pages_id") REFERENCES "public"."industry_landing_pages"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "search_rels_industry_landing_pages_id_idx" ON "search_rels" USING btree ("industry_landing_pages_id");
