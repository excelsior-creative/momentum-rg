  ...
  return (
    <div className="flex flex-col">
      <PageHero
        ...
        subtitle="We take the stress out of being a landlord. From tenant screening to maintenance to compliance, Momentum Realty Group manages your investment so you can focus on what matters."
        backgroundImage="https://momentumrg.com/wp-content/uploads/2025/06/New-Project-1-scaled.png"
      />
