...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/mortgages`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.75 },
    { url: `${SITE_URL}/investments`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.75 },
    { url: `${SITE_URL}/property-management`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.85 },
    { url: `${SITE_URL}/property-management/multi-unit`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    { url: `${SITE_URL}/real-estate-solutions`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${SITE_URL}/listings?city=la-mirada`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.78 },
    { url: `${SITE_URL}/listings?city=anaheim`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.8 },
    { url: `${SITE_URL}/listings?city=riverside`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.78 },
    ...
    { url: `${SITE_URL}/areas/la-mirada`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.78 },
    { url: `${SITE_URL}/areas/anaheim`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    { url: `${SITE_URL}/areas/riverside`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.78 },
